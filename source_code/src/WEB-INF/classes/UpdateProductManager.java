...
public class UpdateProductManager extends HttpServlet {  // JDK 6 and above only
...
System.out.println("int add product page update page");
           ...
           String category = request.getParameter("category_up");
		   String product_id = request.getParameter("id_up");
		   String product_name = request.getParameter("prod_up");
			String product_price = request.getParameter("price_up");
String product_brand = request.getParameter("brand_up");
String product_image = request.getParameter("image_up");	
...
MySQLDataStoreUtilities.updateProduct(product_id,category,product_name,product_image,product_brand,"yes",pr);
