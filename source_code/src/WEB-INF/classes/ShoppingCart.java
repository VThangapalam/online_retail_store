...
public class ShoppingCart {
  ...
  public synchronized void addItem(String itemID) {
    ...
    //ItemOrder newOrder = new ItemOrder(SaxParser4BestDealXMLdataStore.getItem(itemID));
      ItemOrder newOrder = new ItemOrder(BestDealSerializedDataStore.getItem(itemID));
  ...
  public synchronized void setNumOrdered(String itemID,
    ...
    ItemOrder newOrder =
      new ItemOrder(SaxParser4BestDealXMLdataStore.getItem(itemID));
    itemsOrdered.add(newOrder);
  }
}
