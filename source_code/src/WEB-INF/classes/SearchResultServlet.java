...
public class SearchResultServlet extends HttpServlet {  // JDK 6 and above only
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
	       ...
	       String proId = request.getAttribute("product").toString();
				   
				     System.out.println("in seart res servl!!!!");
 System.out.println("id "+proId);
					  Product product = BestDealSerializedDataStore.getProducts().get(proId);
