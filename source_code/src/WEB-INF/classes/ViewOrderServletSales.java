...
public class ViewOrderServletSales extends HttpServlet {  // JDK 6 and above only
  ...
  static List<Product> products;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
               throws ServletException, IOException {
				System.out.println("View order servlet get");   
...
"<td><form method=\"post\" action=\"http://localhost:8999/A2/vieworderupdatesales\">"+
...
"<td><form method=\"post\" action=\"http://localhost:8999/A2/vieworderdeletesales\">"+
"<input type=\"hidden\"  name=\"itemId\" value=\""+order.getItemID()+"\"></input>"+
"<input type=\"hidden\" name=\"orderId\" value=\""+orderid+"\"></input>"+
...
"</tr>");
			...
			out.println("<div id =\"message\">exits</div>");
		}
